...
namespace pruebas
{
    public partial class Letter_S2 : Form
    {
        ...
        public PictureBox pb()
        {
            ...
            CartasJuego.MouseEnter += BT_Mou_Ove2;
            CartasJuego.MouseClick += BT_Mou_Cli;
        ...
        //---------BOTONES
        private void BT_Mou_Ove(object sender, EventArgs e)
        {
            if (act == 1)
            {
                ...
                //var p2b = panel1.Controls[0].Controls.OfType<PictureBox>().ToList();
                ...
                //if (p2b.Count(x => x.BorderStyle == BorderStyle.Fixed3D) > 5)
                //{
                //    string sum = "";
                //    p2b.Where(x => x.BorderStyle == BorderStyle.Fixed3D).ToList().ForEach(y =>
                //    {
                //        sum += y.Name.ToString();
                ...
                //        ver11.ForEach(x =>
                //        {
                //            p2b.Single(y => y.Name == x.ToString()).BorderStyle = BorderStyle.FixedSingle;
                //            p2b.Single(y => y.Name == x.ToString()).Enabled = false;
                //            act = 0;
                //        });
                //    }
                //}
        ...
        int act = 0;
        private void BT_Mou_Cli(object sender, MouseEventArgs e)
        {
        ...
        private void BT_Mou_Ove2(object sender, EventArgs e)
        {
            var Mcon = panel1.Controls[0].Controls.OfType<PictureBox>().ToList();
            //int sele = Mcon.Count(x => x.BorderStyle == BorderStyle.Fixed3D);
        ...
        {
            //var Mcon = panel1.Controls[0].Controls.OfType<PictureBox>().ToList();
            //var Mcon = panel1.Controls[0].Controls.OfType<Control>().ToList();
            //Mcon => opciones lambda List
        }
